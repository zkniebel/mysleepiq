...
SLEEP_NUMBER_FAVORITE = "sleep_number_favorite"
SENSOR_TYPES = {SLEEP_NUMBER: "SleepNumber", IS_IN_BED: "Is In Bed", SLEEP_NUMBER_FAVORITE: "SleepNumberFavorite"}
...
class SleepIQSensor(Entity):
    ...
    def __init__(self, sleepiq_data, bed_id, side):
        ...
        self.side = None
        self.bed = None
        self.fav_sleep_number = PRESET_FAVORITE
    ...
    def update(self):
        ...
        self.fav_sleep_number = self.sleepiq_data.get_favorite_sleep_number(self._bed_id, self._side.lower())